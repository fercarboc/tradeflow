...
CREATE TABLE IF NOT EXISTS public.trade_marketplace_balances (
  ...
  pending_amount            numeric(15,4) NOT NULL DEFAULT 0,
  available_amount          numeric(15,4) NOT NULL DEFAULT 0,
  reserved_amount           numeric(15,4) NOT NULL DEFAULT 0,
  negative_amount           numeric(15,4) NOT NULL DEFAULT 0,
  ...
  historical_settled_amount numeric(15,4) NOT NULL DEFAULT 0,
  ...
  projection_strategy       text         NOT NULL DEFAULT 'ledger_rebuild',

  created_at                timestamptz  NOT NULL DEFAULT now(),
  updated_at                timestamptz  NOT NULL DEFAULT now(),

  PRIMARY KEY (id),
  UNIQUE (provider_actor_id, currency),
