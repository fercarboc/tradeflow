-- ═══════════════════════════════════════════════════════════════════════════
-- MP-FIN-2C FIX: auth.uid() → NULL en mkt_fin_audit (p_actor_id)
-- trade_marketplace_audit_log.actor_id FK → trade_marketplace_actors.
-- auth.uid() es el usuario Supabase, no un marketplace actor → FK violation.
-- Patrón correcto (igual que mkt_fin_create_refund): NULL como p_actor_id.
-- ═══════════════════════════════════════════════════════════════════════════
...
BEGIN
  ...
  -- FIX: NULL como p_actor_id (auth.uid() no es marketplace actor → FK violation)
