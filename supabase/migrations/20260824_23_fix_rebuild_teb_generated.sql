-- MP-FIN-2E FIX 1: total_economic_balance is GENERATED ALWAYS in trade_marketplace_balances
-- mkt_fin_rebuild_provider_balance cannot INSERT/UPDATE it explicitly.
