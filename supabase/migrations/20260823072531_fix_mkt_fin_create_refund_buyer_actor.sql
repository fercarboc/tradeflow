...
BEGIN
  ...
  -- FIX mig-14: buyer_actor_id = NULL (trade_marketplace_actors no tiene org_id; campo nullable Phase 0)
  ...
  PERFORM public.mkt_fin_audit(
    ...
    jsonb_build_object('refund_number', v_refund_number,
      'ledger_goods_entry', v_source_goods, 'ledger_ship_entry', v_source_ship),
...
COMMENT ON FUNCTION public.mkt_fin_create_refund IS
  ...
  'buyer_actor_id=NULL (actors sin org_id en Phase 0, mig-14).';
