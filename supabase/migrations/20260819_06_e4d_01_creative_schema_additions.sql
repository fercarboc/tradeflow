-- ═══════════════════════════════════════════════════════════════════════════
-- E4.D — Migration 1: Schema additions para flujo editorial de creatividades
-- ═══════════════════════════════════════════════════════════════════════════
-- OBJETIVO: Añadir columnas de auditoría del ciclo editorial, índice único
-- para garantizar máximo 1 creatividad activa por campaña, y actualizar
-- admin_get_ad_creatives para incluir los nuevos campos.
--
...
-- Protege contra activación dual concurrente.
-- La columna activa=true sólo puede existir 1 vez por campaign_id.
...
-- El proveedor necesita leer el motivo de rechazo y la fecha de publicación.
-- published_by es dato de auditoría interna (no se expone al proveedor).
