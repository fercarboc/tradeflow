...
export const DEMO_LATERAL_CAMPAIGNS: AdCampaign[] = [
  ...
  {
    id:             'demo-left-mid',
    slotId:         'MARKET_HOME_LEFT_MID',
    advertiserName: 'Hidrosur',
    eyebrow:        'Fontanería y saneamiento',
    title:          'Cobre, PVC y multicapa',
    subtitle:       'Entrega 24h · Stock garantizado',
    ...
    active:    true,
    accent:    '#22d3ee',
    bg:        'linear-gradient(160deg, #082f49 0%, #0c4a6e 80%, #082f49 100%)',
    textColor: '#ffffff',
  },
  {
    id:             'demo-left-bottom',
  ...
  {
    id:             'demo-right-mid',
    slotId:         'MARKET_HOME_RIGHT_MID',
    advertiserName: 'Maderas del Norte',
    eyebrow:        'Carpintería y madera',
    title:          'Tableros, molduras y tarima',
    subtitle:       'Corte a medida · Precios mayorista',
    ctaLabel:       'Ver carpintería',
    destinationType:  'category',
    destinationValue: 'carpinteria',
    priority:  10,
    active:    true,
    accent:    '#f59e0b',
    bg:        'linear-gradient(160deg, #2a1a00 0%, #451a03 80%, #2a1a00 100%)',
    textColor: '#ffffff',
  },
  {
