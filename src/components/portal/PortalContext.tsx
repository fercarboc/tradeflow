...
export type PortalTab = 'dashboard' | 'catalogo' | 'pedidos' | 'equipo' | 'informes' | 'integraciones' | 'config';

const VALID_TABS: PortalTab[] = ['dashboard', 'catalogo', 'pedidos', 'equipo', 'informes', 'integraciones', 'config'];
