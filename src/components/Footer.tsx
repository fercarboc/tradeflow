...
import { Phone, Mail, ShieldCheck, AlertTriangle } from 'lucide-react';
    ...
    <footer className="bg-[#020B16] border-t border-white/8 text-white/45" id="app-footer">
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4" id="footer-grid">
          ...
          <div className="space-y-5">
            <div
              ...
              id="footer-logo"
            >
              <img src="/tradeflow.png" alt="TrabFlow AI" className="h-8 w-auto" />
            ...
            <p className="text-xs text-white/40 leading-relaxed max-w-[240px]">
              Plataforma inteligente para instaladores y autónomos en España. Presupuestos por voz e imagen, facturación y envío por WhatsApp.
            </p>
            ...
            <div className="flex items-start gap-1.5 text-[11px] text-[#FFC400]/70 leading-relaxed max-w-[260px]">
              <AlertTriangle className="h-3.5 w-3.5 mt-0.5 shrink-0" />
              <span>
                La IA puede generar errores. Revisa siempre presupuestos, precios, impuestos y facturas antes de enviarlos.
              </span>
            </div>

            <div className="inline-flex rounded-full border border-[#00CFE8]/20 bg-[#00CFE8]/10 px-3 py-1 text-[10px] font-bold uppercase tracking-widest text-[#00CFE8]">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-sm">
              {[
                ...
                <li key={item.label}>
                  <button onClick={() => handleNavigate(item.page)} className="hover:text-white transition-colors cursor-pointer text-left">
                    {item.label}
                  </button>
                </li>
              ))}
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              <a href="tel:+34672336572" className="flex items-center gap-2.5 text-sm text-white/50 hover:text-[#FFC400] transition-colors group">
              ...
              <a href="mailto:contacto@trabflow.com" className="flex items-center gap-2.5 text-sm text-white/50 hover:text-[#00CFE8] transition-colors group">
            ...
            <p className="text-[10.5px] text-white/30 leading-relaxed">
              Al registrarte aceptas los Términos y Condiciones, la Política de Privacidad y el uso responsable de funcionalidades basadas en IA.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-white/8">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/25">
          <span>
            © {currentYear} TrabFlow Technologies S.L. · Todos los derechos reservados · Made in Spain 🇪🇸
          </span>

          <div className="flex flex-wrap justify-center gap-4">
            <button onClick={() => handleNavigate(ActivePage.Terminos)} className="hover:text-white/50 transition-colors cursor-pointer">Términos</button>
            ...
            <button onClick={() => handleNavigate(ActivePage.AvisoLegal)} className="hover:text-white/50 transition-colors cursor-pointer">Aviso legal</button>
          </div>
        </div>
      </div>
    </footer>
