    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-1 text-sm">Te enviaremos un enlace para crear una nueva contraseña</p>
        </div>
        ...
        <div className="bg-slate-800 rounded-2xl border border-slate-700 p-8 shadow-2xl">
          ...
          <div className="mt-6 pt-5 border-t border-slate-700 text-center">
            <button
              ...
              className="text-sm text-slate-400 hover:text-white transition flex items-center justify-center gap-1 mx-auto"
            >
