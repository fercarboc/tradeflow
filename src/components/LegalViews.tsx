...
export default function LegalViews({ page, setCurrentPage }: LegalViewProps) {
  ...
  return (
    <div className="bg-[#020B16] min-h-screen font-sans" id={`legal-view-${page}`}>
      <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">

      <div className="mb-8 flex items-center gap-3 border-b border-white/10 pb-6">
        <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-white/5 text-[#00CFE8] border border-white/10 shrink-0">
        ...
        <div>
          ...
          <p className="text-[10px] text-white/30 font-mono uppercase mt-1">Última actualización: Mayo de 2026</p>
        </div>
      </div>

      {page === ActivePage.AvisoLegal && (
        <div className="space-y-6 leading-relaxed text-sm text-white/55" id="aviso-legal-content">
          <section className="space-y-3">
            <h2 className="text-md font-display font-bold uppercase tracking-wider text-white">1. Datos Identificativos</h2>
            <p>
            ...
            <ul className="list-disc pl-5 space-y-1.5 font-sans">
              ...
              <li><strong>Email de Contacto:</strong> <span className="text-[#00CFE8] font-semibold font-mono">soporte@trabflow.com</span></li>
              <li><strong>Actividad Social:</strong> Desarrollo de soluciones de software de productividad para instaladores.</li>
            </ul>
          </section>

          <section className="space-y-3">
            <h2 className="text-md font-display font-bold uppercase tracking-wider text-white">2. Usuarios e Condiciones</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-md font-display font-bold uppercase tracking-wider text-white">3. Uso de la Web y Limitaciones de la Beta</h2>
            <p>
              <code className="bg-white/10 text-[#00CFE8] border border-white/15 px-1.5 py-0.5 rounded text-xs font-mono">trabflow.com</code> proporciona el acceso a multitud de informaciones, servicios o datos pertenecientes a TrabFlow Technologies S.L. o a sus licenciantes a los que el USUARIO pueda tener acceso.
            </p>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-md font-display font-bold uppercase tracking-wider text-white">4. Propiedad Intelectual e Industrial</h2>
            <p>
      ...
      {page === ActivePage.Privacidad && (
        <div className="space-y-6 leading-relaxed text-sm text-white/55" id="privacidad-content">
          <section className="space-y-3">
            <h2 className="text-md font-display font-bold uppercase tracking-wider text-white">1. Responsable del Tratamiento</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-md font-display font-bold uppercase tracking-wider text-white">2. Finalidad del Tratamiento de Datos</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-md font-display font-bold uppercase tracking-wider text-white">3. Datos Solicitados</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-md font-display font-bold uppercase tracking-wider text-white">4. Derechos del Usuario</h2>
            <p>
              Cualquier instalador inscrito tiene derecho a obtener confirmación sobre si en TrabFlow estamos tratando sus datos personales. Tiene derecho a acceder a sus datos personales, así como a solicitar la rectificación de los datos inexactos o, en su caso, solicitar su supresión cuando, entre otros motivos, los datos ya no sean necesarios para los fines que fueron recogidos. Puede solicitar la baja instantánea de nuestra lista de espera enviando un correo con el asunto "BAJA BETA" a <span className="text-[#00CFE8] font-semibold font-mono">soporte@trabflow.com</span>.
            </p>
          </section>
        </div>
      )}
      ...
      {page === ActivePage.Cookies && (
        <div className="space-y-6 leading-relaxed text-sm text-white/55" id="cookies-content">
          <p>
          ...
          <section className="space-y-3">
            <h2 className="text-md font-display font-bold uppercase tracking-wider text-white">1. ¿Qué es una Cookie?</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-md font-display font-bold uppercase tracking-wider text-white">2. Tipos de Cookies que utilizamos</h2>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 mt-4">
              <div className="p-4 rounded-xl border border-white/10 bg-white/5">
                <span className="font-bold text-white block text-xs uppercase tracking-wide mb-1">Cookies Técnicas (Esenciales)</span>
                <p className="text-xs text-white/40">Necesarias para la carga correcta del sitio de TrabFlow, el funcionamiento del cambio de pestañas de navegación, y el estado del formulario de suscripción.</p>
              </div>
              <div className="p-4 rounded-xl border border-white/10 bg-white/5">
                <span className="font-bold text-white block text-xs uppercase tracking-wide mb-1">Cookies Analíticas (Opcionales)</span>
                <p className="text-xs text-white/40">Recopilan información anónima sobre el número de visitantes, el tiempo en la página de precios, y qué oficios son los más demandados en la beta móvil.</p>
              </div>
            </div>
          </section>

          <section className="space-y-3">
            <h2 className="text-md font-display font-bold uppercase tracking-wider text-white">3. Control y Desactivación</h2>
            <p>
      ...
      {/* Action panel */}
      <div className="mt-12 rounded-2xl border border-white/10 bg-[#0d1f38] p-6 flex flex-col md:flex-row items-center justify-between gap-4">
        <div>
          <span className="font-black text-white text-xs block uppercase tracking-widest mb-1">¿Tienes dudas sobre los términos?</span>
          <p className="text-xs text-white/40">Nuestros términos están pensados para proteger tu negocio. Escríbenos.</p>
        </div>
        <button
          onClick={handleGoContact}
          className="rounded-xl bg-[#FFC400] text-[#020B16] px-5 py-2.5 font-black uppercase tracking-widest text-xs hover:brightness-110 transition-all cursor-pointer whitespace-nowrap shadow-lg shadow-[#FFC400]/15"
        >
