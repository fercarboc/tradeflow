      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex flex-col leading-none">
            ...
            <span className="text-[8px] font-semibold tracking-[0.18em] text-white/40 uppercase">
        ...
        <div className="hidden md:flex items-center gap-2" id="desktop-cta">
          <button
            onClick={handleLogin}
            className="px-4 py-2 text-xs font-bold uppercase tracking-wider text-white/80 border border-white/20 rounded-lg hover:border-white/50 hover:text-white transition-colors cursor-pointer"
          ...
          <button
            ...
            className="px-4 py-2 text-xs font-bold uppercase tracking-wider text-[#020B16] bg-[#FFC400] rounded-lg hover:bg-[#ffd740] transition-colors cursor-pointer flex items-center gap-1.5 shadow-lg shadow-[#FFC400]/20"
        ...
        <button
          ...
          className="flex md:hidden h-10 w-10 items-center justify-center text-white/80 hover:text-white"
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="bg-[#020B16] border-b border-white/10 md:hidden overflow-hidden"
            id="mobile-nav-panel"
          >
            <div className="px-4 pb-6 pt-2 space-y-1">
              ...
              <div className="pt-4 mt-2 border-t border-white/10 flex flex-col gap-2">
                <button
                  onClick={() => handleNavigate(ActivePage.AppDashboard, true)}
                  className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#FFC400] py-3 font-bold text-sm text-[#020B16] cursor-pointer"
                  id="mobile-demo-btn"
                >
                ...
                <button
                  onClick={handleLogin}
                  className="flex w-full items-center justify-center gap-2 rounded-xl border border-white/20 py-3 font-semibold text-sm text-white/80 cursor-pointer hover:bg-white/5"
                  id="mobile-login-btn"
                >
